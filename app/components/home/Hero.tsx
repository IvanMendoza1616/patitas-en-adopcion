...
export default function Hero() {
  return (
    <section className="px-4">
      <div className="relative m-auto flex max-w-[1200px] flex-col items-center justify-center gap-4 overflow-hidden rounded-lg bg-primary-light px-8 py-16 text-center md:py-32">
        ...
        <div className="flex flex-col justify-center gap-4 sm:flex-row sm:gap-8">
          ...
          <Link
            ...
            className="hover:bg-primary-light-hover flex items-center justify-center gap-2 rounded-md bg-white px-8 py-3 shadow-md transition ease-in-out"
          >
