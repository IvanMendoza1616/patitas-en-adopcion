...
export default function HowItWorks() {
  return (
    <section className="to-primary-light bg-gradient-to-b from-white px-4">
      <div className="m-auto flex max-w-[1200px] flex-col items-center justify-center gap-12 py-16 text-center md:py-32">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div className="relative flex flex-col items-center justify-center gap-2 overflow-hidden rounded-lg border bg-white p-8 shadow-md">
            <p className="bg-primary absolute left-0 top-0 flex aspect-square w-[40px] items-center justify-center rounded-br-lg text-white">
              1
            </p>
            <MagnifyingGlassIcon className="text-primary bg-primary-light w-16 rounded-full p-2" />
          ...
          <div className="relative flex flex-col items-center justify-center gap-2 overflow-hidden rounded-lg border bg-white p-8 shadow-md">
            ...
            <ClipboardIcon className="text-primary bg-primary-light w-16 rounded-full p-2" />
          ...
          <div className="relative flex flex-col items-center justify-center gap-2 overflow-hidden rounded-lg border bg-white p-8 shadow-md">
            ...
            <HomeIcon className="text-primary bg-primary-light w-16 rounded-full p-2" />
